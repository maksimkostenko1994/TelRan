...
(function (define) {
    ...
    define('newt',['require','28-06-HomeTask/requirejs-master/tests/universal/tail','eye'],function (require) {
        //If have dependencies, get them here
        var tail = require('28-06-HomeTask/requirejs-master/tests/universal/tail'),
            eye = require('28-06-HomeTask/requirejs-master/tests/universal/eye');
...
(function (define) {
    ...
    //a popular web library that is used mostly in
    //non-AMD/Node environments.
    define('spell', ['require','28-06-HomeTask/requirejs-master/tests/universal/newt'],function (require) {
        //If have dependencies, get them here
        var newt = require('28-06-HomeTask/requirejs-master/tests/universal/newt');
