...
define('a',['28-06-HomeTask/requirejs-master/tests/plugins/c', 'c/sub'], function (c, csub) {
    return {
        c: c,
        csub: csub
    };
...
define('b',['28-06-HomeTask/requirejs-master/tests/plugins/c', 'c/sub'], function (c, csub) {
    return {
        c: c,
        csub: csub
    };
...
define('a/sub/one',['28-06-HomeTask/requirejs-master/tests/plugins/c', 'c/sub'], function (c, csub) {
    return {
        c: c,
        csub: csub
    };
