...
//ending comment;
define("b", ["28-06-HomeTask/requirejs-master/tests/plugins/a","d"], function(){});
...
define("c", ["28-06-HomeTask/requirejs-master/tests/plugins/a","b"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.C;
    };
...
define("f", ["28-06-HomeTask/requirejs-master/tests/plugins/a"], (function (global) {
    return function () {
        var ret, fn;
       fn = function (a) {
                    return {
...
require({
    ...
    ['28-06-HomeTask/requirejs-master/tests/plugins/a', 'c', 'e', 'f'],
    function(a, c, e, f) {
        doh.register(
            'shimBasic',
            [
