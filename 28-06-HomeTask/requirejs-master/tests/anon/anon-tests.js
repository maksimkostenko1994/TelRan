require({
    ...
    ["require", "28-06-HomeTask/requirejs-master/tests/anon/magenta", "red", "blue", "green", "yellow", "a", "c"],
            ...
            [
                function colors(t){
                    ...
                    if (requirejs.isBrowser) {
                        setTimeout(function () {
                            require(["28-06-HomeTask/requirejs-master/tests/anon/blue", "red", "magenta"], function (blue, red) {
                                doh.register(
                                    "anonSimpleCached",
                                    [
